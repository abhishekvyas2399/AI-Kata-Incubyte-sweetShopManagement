...
export default function AdminDashboard() {
  ...
  return (
    <div className=" overflow-x-auto bg-gradient-to-r from-[#b95b45] to-[#b17459]">
      <div className="flex justify-between bg-gradient-to-r from-[#fbdfca] via-[#f1a697] to-[#b95b45] shadow-2xl">
        <h1 className="text-2xl font-bold m-2"> Sweet Shop Admin Dashboard</h1>
        <button className="bg-gradient-to-r from-[#d86060] via-[#cf3c37] to-[#bb2424] hover:bg-red-600 text-white font-medium px-4 py-1 m-2 h-8 w-19 rounded"
      ...
      <div className="container mx-auto p-4">
          <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-3 
            zxl:gap-2 gap-4 shadow-2xl">
              
            <div className="w-full flex flex-col items-center justify-centerfont-bold p-2 bg-amber-50 rounded-2xl">

              <div className="text-2xl font-medium p-2 text-black">Category</div>
          ...
          <div className="w-full overflow-auto flex flex-col items-center justify-centerfont-bold bg-amber-50 rounded-2xl">

            <div className="text-2xl font-medium p-2 text-black"> Add update restock sweets</div>

            {/* Add / Edit Sweet */}
            <form onSubmit={handleSubmit} className=" space-x-2 m-4 flex flex-col items-center bg-white rounded-lg shadow-md">
          ...
          md:col-span-3 lg:col-span-3 xl:col-span-3 p-2 rounded-2xl">
              ...
              <button className="bg-green-500 text-white px-4 py-2 rounded m-4" 
                ...
                <table className="border-collapse border w-full">
                  ...
                  <tbody>
                    {Array.isArray(items) && items?.map((sweet) => (
                      <tr key={sweet.id}>
                        <td className="border-b p-2 text-center">{sweet.name}</td>
                        <td className="border-b p-2 text-center">{sweet.category.name}</td>
                        <td className="border-b p-2 text-center">{sweet.price}</td>
                        <td className="border p-2 flex justify-around text-center">
