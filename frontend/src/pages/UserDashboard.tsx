...
import sweetImage from "../assets/sweetHomeImg.png"
  ...
  return (
    <div className=" overflow-x-auto bg-gradient-to-r from-[#b95b45] to-[#b17459]">
      <div className="flex justify-between bg-gradient-to-r from-[#fbdfca] via-[#f1a697] to-[#b95b45] shadow-2xl">
        <h1 className="text-2xl font-bold m-2"> sweet shop </h1>
      ...
      <div className="relative w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <h1 className="text-white text-2xl sm:text-4xl font-bold">Welcome to Sweet Shop</h1>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <table className="border-collapse border w-full min-w-[600px] text-center ">
          <thead>
            <tr >
          ...
          <tbody>
            {items.map((sweet:any) => {
              ...
              return (
                <tr key={sweet.id}>
                  <td className="border-b p-2">{sweet.name}</td>
                  <td className="border-b p-2">{sweet.category.name}</td>
                  <td className="border-b p-2">{sweet.price}</td>
                  <td className="border-b p-2">{sweet.quantity}</td>
